    ...
    <v-container>
        <v-card dark color="indigo darken-1" rounded outlined>
            ...
            <v-list dense>
                ...
                <v-list-item-group v-model="item" active-class="active-list-item">
                    ...
                    <!-- Check Me -->
                    <v-list-item @click="CheckMe" v-for="item in items" :key="item" dense style="height:20px">
                        <v-list-item-action>
        ...
        <v-card class="mt-3" rounded outlined>
            <v-card-title class="mb-2">
                ...
                <v-spacer></v-spacer><!-- Check Me -->
                <v-icon @click="Checkme" small>more_horiz</v-icon>
            </v-card-title>
            <v-divider></v-divider>
            <v-list-item dense>
                <v-list-item-icon>
                ...
                <v-list-item-content>
                    <div class="questrial caption text--grey">There is a meetup in your city on Friday at 8:45pm. <div class="indigo--text font-weight-bold"> See Details</div>
                    </div>
                </v-list-item-content>
            </v-list-item>
            <v-list-item dense>
...
<style>
.active-list-item .v-list-item--dense .v-list-item__title,
