        ...
        <v-layout row wrap>
            <v-flex xs6>
                <v-card color="purple" dark>
                    <v-img :src="`https://picsum.photos/500/300?image=${10 * 5 + 10}`" :lazy-src="`https://picsum.photos/10/6?image=${10 * 5 + 10}`" aspect-ratio="1" class="grey lighten-2">
                    ...
                    <v-flex v-on="on">
                        <v-layout>
                            <v-avatar size="20" class="ml-1">
                                <v-img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-face-with-heart-shaped-eyes_1f60d.png">
                                </v-img>
                            </v-avatar>
                            <v-avatar size="20" class="ml-1">
                                <v-img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/smiling-cat-face-with-heart-shaped-eyes_1f63b.png">
                                </v-img>
                            </v-avatar>
                            <v-avatar size="20" class="ml-1">
                                <v-img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/facebook/65/hamburger_1f354.png">
                                </v-img>
                            </v-avatar>
