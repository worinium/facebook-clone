...
<v-app-bar dense clipped-left clipped-right color="indigo darken-2" dark app>
    ...
    <v-spacer></v-spacer>
    <v-text-field append-icon="mdi-magnify" class="mt-8 questrial" label="Search" rounded solo light></v-text-field>
    <v-spacer></v-spacer>
    <v-toolbar-items>
        <v-btn icon>
            <v-icon color="black lighten-4">mdi-account</v-icon>
        </v-btn>
        <v-btn icon>
            <v-icon color="black lighten-4">mdi-information</v-icon>
        </v-btn>
        <v-btn icon>
            <v-icon color="black lighten-4">mdi-account-group-outline</v-icon>
        </v-btn>
        <v-btn icon>
            <v-icon color="black lighten-4">mdi-cog</v-icon>
        </v-btn>
