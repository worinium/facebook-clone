...
export default {
    ...
    data() {
        return {
            ...
            colleagues: [{
                    name: 'Small Kaydence',
                    avatar: require('../assets/avatars/6.png'),
                    online: false
                },
                {
                    name: 'Valenzuela Rudy',
                    avatar: require('../assets/avatars/7.png'),
                    online: false
                },
                {
                    name: 'Harris Marin',
                ...
                {
                    name: 'Bailey Kirsten',
                    avatar: require('../assets/avatars/9.png'),
                    online: false
                },
                {
                    name: 'Rice Wade',
            ...
            clubs: [{
                    name: 'Chang Zander',
                    avatar: require('../assets/avatars/11.png'),
                    online: true
                },
                {
                    name: 'Calhoun Kayla',
                ...
                {
                    name: 'Malone Terrance',
                    avatar: require('../assets/avatars/15.png'),
                    online: false
                },
            ]
        }
