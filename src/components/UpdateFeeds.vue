...
<v-card rounded outlined>
    <div>
        <v-list-item>
            ...
            <v-list-item-action>
                <v-icon @click="CheckMe">mdi-check-circle</v-icon>
            </v-list-item-action>
        </v-list-item>
    </div>
            ...
            <v-flex class="text-right">
                <v-layout wrap justify-end>
                    <div class="questrial mr-3 font-weight-bold ">
                        2 Comments
                        <v-icon v-if="false" @click="CheckMe" small>mdi-check-circle</v-icon>
                        <v-icon @click="CheckMe" small>mdi-check-circle</v-icon>
                    </div>
    ...
    <div class="px-4">
        <v-text-field class="questrial" height="45px" background-color="grey lighten-3" append-icon="mdi-check-circle" placeholder="Write a comment..." rounded></v-text-field>
    </div>
</v-card>
</v-row>
