                    ...
                    <v-flex xs12>
                        <v-card rounded outlined>
                            ...
                            <div class="px-3">
                                <v-layout>
                                    <v-flex xs12>
                                        <v-text-field class="questrial no-top-padding" background-color="grey lighten-3" height="44px" append-icon="photo_camera" rounded placeholder="What's on your mind, Uzir?">
                                    </v-text-field>
                                    </v-flex>
                                </v-layout>
                            </div>
